        ...
        <Table>
          <TableHeader className="bg-slate-50/50">
            <TableRow className="hover:bg-transparent">
              <TableHead className="w-[100px] h-12 text-[11px] font-bold uppercase tracking-wider text-slate-500 pl-6">Date</TableHead>
              <TableHead className="w-[120px] h-12 text-[11px] font-bold uppercase tracking-wider text-slate-500">Image</TableHead>
              ...
              <TableHead className="h-12 text-[11px] font-bold uppercase tracking-wider text-slate-500">Status</TableHead>
            ...
            {currentItems.length > 0 ? (
              currentItems.map((listing) => (
                <TableRow key={listing.id} className="group transition-colors hover:bg-slate-50/50">
                  <TableCell className="text-xs text-slate-500 font-bold pl-6">
                  ...
                  <TableCell>
                    <span className={cn(
                      "inline-flex items-center rounded-lg px-2 py-0.5 text-[10px] font-black uppercase tracking-tight",
